...
You can find this and the data files from ELIXIREstonia github. <https://github.com/ELIXIREstonia/2026-03-05-R-basic>.

For groups with complete beginners, start with `R-basic-warmup.Rmd` before this instructor material.
...
# 1. If you're inviting 10 people, how much will the food cost?
food_cost_total <- food_cost_per_person * number_of_people

# 2. If you're inviting 10 people, how much will the drinks cost?
drink_cost_total <- drink_cost_per_person * number_of_people

# 3. What's the total cost for a party with 10 attendees?
total_cost <- venue_cost + food_cost_total + drink_cost_total + entertainment_cost
...
# Function to calculate total party cost based on attendees
total_party_cost <- function(num_people) {
  venue_cost + (food_cost_per_person * num_people) + 
    (drink_cost_per_person * num_people) + entertainment_cost
}

# Test the function with different attendee numbers
total_party_cost(10)
total_party_cost(20)
total_party_cost(5)
